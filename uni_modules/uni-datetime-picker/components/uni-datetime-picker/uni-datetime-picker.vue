			...
			<slot>
				...
				>
					<view v-if="!isRange" class="uni-date-x uni-date-single">
						<view class="uni-date__x-input" :class="{ valued: displayValue }">{{
					...
					<view v-else class="uni-date-x uni-date-range">
						<view
							...
							:class="{ valued: displayRangeValue.startDate }"
						...
						<view
							class="uni-date__x-input text-center"
							:class="{ valued: displayRangeValue.endDate }"
	...
	computed: {
		...
		showClearIcon() {
			return (
				...
				!this.disabled &&
				(this.displayValue ||
					(this.displayRangeValue.startDate && this.displayRangeValue.endDate))
			);
		},
	},
	created() {
